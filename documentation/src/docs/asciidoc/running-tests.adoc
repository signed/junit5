...
If you are tagging your test across multiple dimensions tag expressions help you to select which tests to execute.

test type: micro, integration, end-to-end
feature: foo, bar, baz
...
| +bar\|baz+                                | all tests for bar and baz
| +foo & !end-to-end+                       | all tests for foo, but not the end-to-end tests
| +(micro \| integration) & (bar \| baz )+  | all micro and integration test for bar and baz
|===
